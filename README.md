...
| Category                         | Level     | Technology                  | POC (starter-templates / experiments)           | Notes                             |
| :------------------------------- | :-------- | :-------------------------- | :---------------------------------------------- | :-------------------------------- |
...
|                                  | `**`      | NPM                         |                                                 |                                   |
|                                  | `*`       | Yarn                        |                                                 |                                   |
| Static site generators           | `*`       | NextJS                      | [nextjs](poc/nextjs)                            |                                   |
| **BACKEND DEVELOPMENT (PYTHON)** |           |                             |                                                 |                                   |
| Langauge                         | `***`     | Python                      | (in many POCs)                                  |                                   |
| App frameworks                   | `***`     | Bottle                      |                                                 |                                   |
|                                  | `**`      | Flask                       | [fullstack-1](poc/fullstack/1)                  |                                   |
|                                  | `*`       | Django                      |                                                 |                                   |
| ORMs & migration tools           | `**`      | SqlAlchemy                  | [fullstack-1](poc/fullstack/1)                  |                                   |
|                                  | `*` `P2`  | Alembic                     |                                                 |                                   |
|                                  | `**`      | DjangoORM `TDPOC`           |                                                 |                                   |
...
| ...                              |           | ... `TD`                    |                                                 | [dotnetcore](notes/dotnetcore.md) |
| **DATABASES**                    |           |                             |                                                 |                                   |
| Relational                       | `*`       | PostgreSQL                  | [3dbs](poc/3dbs) [fullstack-1](poc/fullstack/1) |                                   |
|                                  | `*`       | MySQL                       |                                                 |                                   |
|                                  | `**`      | MS SQL Server               |                                                 |                                   |
| NoSQL                            | `**`      | Redis                       | [3dbs](poc/3dbs) [fullstack-1](poc/fullstack/1) |                                   |
|                                  | `*`       | MongoDB                     | [3dbs](poc/3dbs) [fullstack-1](poc/fullstack/1) |                                   |
...
| **DEVOPS**                       |           |                             |                                                 |                                   |
| Tools                            | `**`      | Docker & docker-compose     | (in many POCs)                                  | [docker](notes/docker.md)         |
|                                  | `*` `P1`  | Helm                        |                                                 |                                   |
...
| Category            | Level | Practice (tools used)                                            | POC (starter-templates / experiments) | Notes                                              |
| :------------------ | :---- | :--------------------------------------------------------------- | :------------------------------------ | :------------------------------------------------- |
| **ENVS & CI/CD**    |       |                                                                  |                                       |                                                    |
...
|                     | `**`  | Contolled code complexity `flake8` with param `max-complexity`   | [fullstack-1](poc/fullstack/1)        |                                                    |
...
| **APP DESIGN**      |       |                                                                  |                                       |                                                    |
| Any kind of apps    | `***` | Extensive logging                                                |                                       | [logging](notes/app-design/logging.md)             |
|                     | `***` | Special endpoints (version, liveness & readyness)                |                                       | [endpoints](notes/app-design/endpoints.md)         |
|                     | `***` | Stateless web app - external session and cache (`redis`)         |                                       |                                                    |
|                     | `***` | Framework / abstract class to enforce dev consistancy            |                                       |                                                    |
|                     | `***` | Mechanism to handle localizations properly                       |                                       | [localizations](notes/app-design/localizations.md) |
|                     | `**`  | (If needed) Consistant way to access various contexts            |                                       | [contexts](notes/app-design/contexts.md)           |
...
|                     | `***` | Define definition of done                                        |                                       | [dod](notes/process/dod.md)                        |
...
|                     | `***` | Daily group review for knowledge sharing                         |                                       | [group-review](notes/process/group-review.md)      |
|                     | `**`  | Daily scrum                                                      |                                       |                                                    |
...
|                     | `***` | Retrospective                                                    |                                       | [retro](notes/process/retro.md)                    |
| Before releases     | `***` | Arrange deployment freeze and regression testing in alpha        |                                       |                                                    |
|                     | `***` | Collect approvals (CAB)                                          |                                       |                                                    |
|                     | `***` | Release notes                                                    |                                       | [release-notes](notes/process/release-notes.md)    |
...
| Documentation       | `**`  | Technical documentation                                          |                                       | [tech-docs](notes/process/tech-docs.md)            |
